...
export default function ActiveLoadingPage() {
  ...
  if (isLoading || !user || user.role !== "operator" || !session || !shipment) {
    return null
  }
  ...
  return (
    <DashboardLayout currentPage="/operator/active">
          ...
          <Card className="border-border/50 bg-card/50">
            ...
            <CardContent>
              <div className="space-y-2">
                ...
                <div className="w-full bg-border/50 rounded-full h-2">
                  <div className="bg-accent h-2 rounded-full transition-all" style={{ width: `${weightProgress}%` }} />
                </div>
              </div>
            </CardContent>
          </Card>
        ...
        {currentItem ? (
                ...
                <div className="grid gap-4 md:grid-cols-3">
                  ...
                  <div>
                    ...
                    <p className="text-lg font-semibold text-foreground">
                      {currentItem.dimensions.length} × {currentItem.dimensions.width} × {currentItem.dimensions.height}
                    </p>
                  </div>
                  <div>
          ...
          <Card className="border-border/50 bg-card/50">
            <CardContent className="pt-6 text-center">
              ...
              <Button onClick={() => router.push("/operator/logs")}>View Session Log</Button>
            </CardContent>
          </Card>
        )}
