  ...
  const quickActions =
    {
      admin: [
        ...
        { label: "New Container", path: "/admin/containers" },
        { label: "View Logs", path: "/admin/logs" },
      ],
      planner: [
        { label: "Create Shipment", path: "/planner/shipment" },
        { label: "View Plans", path: "/planner/planning" },
        { label: "Load Calculation", path: "/planner/planning" },
      ],
      operator: [
        { label: "Start Loading", path: "/operator/instructions" },
        { label: "View Tasks", path: "/operator/active" },
        { label: "Check Logs", path: "/operator/logs" },
      ],
    }[user.role] || []
