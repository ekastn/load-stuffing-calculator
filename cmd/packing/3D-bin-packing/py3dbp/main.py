...
class Packer:
    ...
    def gravityCenter(self,bin):
        ...
        for i in bin.items:
            ...
            for j in range(len(area)):
                ...
                # !include x and !include y
                    ...
                    x_2 = x_ed - x_st - x
                    area[0][2] += x * y / all * float(i.weight)
                    area[1][2] += x_2 * y / all * float(i.weight)
                    area[2][2] += x * y_2 / all * float(i.weight)
                    area[3][2] += x_2 * y_2 / all * float(i.weight)
                    break
        ...
        for i in r :
            result.append(round(i / total_weight * 100,2))
        return result
