...
/**
 * Creates a 3D box representation of an item placement
 */
export class ItemMesh {
    ...
    /**
     * Get rotated dimensions based on rotation code (0-5)
     */
    private getRotatedDims(): { length_mm: number; width_mm: number; height_mm: number } {
        ...
        switch (this.placement.rotation) {
            case 0: return { length_mm: l, width_mm: w, height_mm: h };
            case 1: return { length_mm: w, width_mm: l, height_mm: h };
            case 2: return { length_mm: w, width_mm: h, height_mm: l };
            case 3: return { length_mm: h, width_mm: w, height_mm: l };
            case 4: return { length_mm: h, width_mm: l, height_mm: w };
            case 5: return { length_mm: l, width_mm: h, height_mm: w };
